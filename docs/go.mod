...
require github.com/panyam/s3gen v0.0.33
...
replace github.com/panyam/templar v0.0.20 => ./locallinks/templar/

replace github.com/panyam/s3gen v0.0.33 => ./locallinks/s3gen/

replace github.com/panyam/goutils v0.1.10 => ./locallinks/goutils/
